...
// Discord RPC
#if TF_CLIENT_DLL
static ConVar cl_discord_appid("cl_discord_appid", "1341724624915922944", FCVAR_DEVELOPMENTONLY | FCVAR_CHEAT);
#elif CLIENT_DLL
static ConVar cl_discord_appid("cl_discord_appid", "1329580854279929947", FCVAR_DEVELOPMENTONLY | FCVAR_CHEAT);
#endif
